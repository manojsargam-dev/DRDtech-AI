...
A modern, responsive, and interactive Diagnosis  web application for the **DRDtech AI** Retinal Analysis platform. Built with **React 19**, **Vite**, and clean **Vanilla CSS**, it provides an intuitive interface for clinicians to register patients, upload fundus scans, and inspect AI-driven Diabetic Retinopathy diagnoses with Grad-CAM heatmaps and blood vessel segmentation.
...
- **Real-Time AI Diagnosis  Dashboard**:
...
│   │   ├── Diagnosis Report/# AI Results visualizer & analysis dashboard
